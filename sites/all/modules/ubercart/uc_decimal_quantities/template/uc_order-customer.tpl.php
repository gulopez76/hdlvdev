                          ...
                          <tr>
                            ...
                            <?php
                              if (_product_allows_decimal_quantities($product->nid)) {
                                echo '<b>'. number_format($product->qty, 2) . UC_DECIMAL_QUANTITIES_UNIT .'</b>';
                              }
                              else {
                                echo '<b>'. $product->qty . '&times;</b>';
                              }
                              ?>
                            </td>
                            <td width="98%">
                              ...
                              if (_product_allows_decimal_quantities($product->nid)) {
                                $price_info['qty'] = 1;
                                echo t('(@price per @unit)', array('@price' => uc_price($price_info, $context), '@unit' => UC_DECIMAL_QUANTITIES_UNIT_NAME));
                              }
                              else {
                                if ($product->qty > 1) {
                                  $price_info['qty'] = 1;
