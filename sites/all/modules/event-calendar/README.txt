...
2. Download 'jscolor' library from
...
4. Go to Administer > Site configuration > Spider Calendar to create
calendars, events and themes for calendars.
5. To show created calendar go to Create content > Spider Calendar. Select
calendar, select theme and save content.
