/**
 * Set theme parameters on select.
 */
function spider_calendar_set_block_theme() {
  themeID = document.getElementById('edit-default-themes').value;
  var if_set;
  switch (themeID) {
    case '1':
      if_set = spider_calendar_reset_block_theme_1();
      if (if_set) {
    ...
    case '2':
      if_set = spider_calendar_reset_block_theme_2();
      if (if_set) {
    ...
    case '3':
      if_set = spider_calendar_reset_block_theme_3();
      if (if_set) {
    ...
    case '4':
      if_set = spider_calendar_reset_block_theme_4();
      if (if_set) {
    ...
    case '5':
      if_set = spider_calendar_reset_block_theme_5();
      if (if_set) {
    ...
    case '6':
      if_set = spider_calendar_reset_block_theme_6();
      if (if_set) {
    ...
    case '7':
      if_set = spider_calendar_reset_block_theme_7();
      if (if_set) {
    ...
    case '8':
      if_set = spider_calendar_reset_block_theme_8();
      if (if_set) {
    ...
    case '9':
      if_set = spider_calendar_reset_block_theme_9();
      if (if_set) {
    ...
    case '10':
      if_set = spider_calendar_reset_block_theme_10();
      if (if_set) {
    ...
    case '11':
      if_set = spider_calendar_reset_block_theme_11();
      if (if_set) {
    ...
    case '12':
      if_set = spider_calendar_reset_block_theme_12();
      if (if_set) {
...
/**
 * Reset theme to default parameters.
 */
function spider_calendar_reset_block_theme_1() {
  if (confirm(Drupal.t('Do you really whant to reset theme?'))) {
    document.getElementById("edit-theme-title").value = "Black light";
    document.getElementById("edit-theme-width").value = "175";
    ...
    document.getElementById("edit-show-titles-cloud-1").checked = true;
    document.getElementById("edit-show-titles-cloud-0").checked = false;
    document.getElementById("edit-show-date-and-time-in-titlescloud-1").checked = true;
    document.getElementById("edit-show-date-and-time-in-titlescloud-0").checked = false;
    document.getElementById("edit-titles-cloud-text-color").color.fromString("000000");
    document.getElementById("edit-body-bgcolor").color.fromString("363636");
    document.getElementById("edit-cell-height").value = "30";
    document.getElementById("edit-omd-fcolor").color.fromString("BDBDBD");
    document.getElementById("edit-omd-bgcolor").color.fromString("363636");
    ...
    document.getElementById("edit-cell-text-color-selected-events").color.fromString("000000");
    document.getElementById("edit-cell-bgcolor-events").color.fromString("F0F0F0");
    document.getElementById("edit-cell-bgcolor-selected-events").color.fromString("FFFFFF");
    ...
    document.getElementById("edit-selected-day-cell-border-color").color.fromString("000000");
    document.getElementById("edit-cell-border-color").color.fromString("000000");
    document.getElementById("edit-all-days-border").value = "0";
    document.getElementById("edit-sundays-tcolor").color.fromString("FFFFFF");
    document.getElementById("edit-sundays-cell-bgcolor").color.fromString("363636");
    document.getElementById("edit-sundays-fcolor").value = "14";
    document.getElementById("edit-days-fsize").value = "12";
    document.getElementById("edit-time-in-cell-1").checked = false;
    document.getElementById("edit-time-in-cell-0").checked = true;
    document.getElementById("edit-header-heidht").value = "30";
    ...
    document.getElementById("edit-next-month-fsize").value = "9";
    ...
    document.getElementById("edit-prev-month-fsize").value = "9";
    ...
    document.getElementById("edit-weekdays-bgcolor").color.fromString("2A2829");
    document.getElementById("edit-sunday-bgcolor").color.fromString("2A2829");
...
function spider_calendar_reset_block_theme_2() {
  if (confirm(Drupal.t('Do you really whant to reset theme?'))) {
    document.getElementById("edit-theme-title").value = "Blue Dark";
    document.getElementById("edit-theme-width").value = "175";
    document.getElementById("edit-week-start-day").value = "su";
    document.getElementById("edit-border-color").color.fromString("00004F");
    ...
    document.getElementById("edit-omd-bgcolor").color.fromString("5BCAFF");
    ...
    document.getElementById("edit-cell-text-color-selected-events").color.fromString("FFFFFF");
    document.getElementById("edit-cell-bgcolor-events").color.fromString("00004F");
    document.getElementById("edit-cell-bgcolor-selected-events").color.fromString("000000");
    document.getElementById("edit-event-title-color").color.fromString("FFFFFF");
    document.getElementById("edit-cur-day-cell-border-color").color.fromString("FFFFFF");
    document.getElementById("edit-selected-day-cell-border-color").color.fromString("FFFFFF");
    document.getElementById("edit-cell-border-color").color.fromString("000000");
    document.getElementById("edit-all-days-border").value = "0";
    document.getElementById("edit-sundays-tcolor").color.fromString("000000");
    document.getElementById("edit-sundays-cell-bgcolor").color.fromString("5BCAFF");
    document.getElementById("edit-sundays-fcolor").value = "14";
    document.getElementById("edit-days-fsize").value = "12";
    document.getElementById("edit-time-in-cell-1").checked = false;
    document.getElementById("edit-time-in-cell-0").checked = true;
    ...
    document.getElementById("edit-year-arrow-color").color.fromString("FFFFFF");
    document.getElementById("edit-month-type").value = "2";
    ...
    document.getElementById("edit-weekdays-bgcolor").color.fromString("00004F");
    document.getElementById("edit-sunday-bgcolor").color.fromString("00004F");
    document.getElementById("edit-weekdays-fsize").value = "14";
    document.getElementById("edit-event-title-color-popup").color.fromString("000000");;
...
function spider_calendar_reset_block_theme_3() {
  if (confirm(Drupal.t('Do you really whant to reset theme?'))) {
    ...
    document.getElementById("edit-border-radius").value = "3";
    ...
    document.getElementById("edit-cell-height").value = "30";
    document.getElementById("edit-omd-fcolor").color.fromString("CCCCCC");
    document.getElementById("edit-omd-bgcolor").color.fromString("E3F9F9");
    ...
    document.getElementById("edit-cell-bgcolor-selected-events").color.fromString("346699");
    document.getElementById("edit-event-title-color").color.fromString("000000");
    ...
    document.getElementById("edit-sundays-cell-bgcolor").color.fromString("E3F9F9");
    document.getElementById("edit-sundays-fcolor").value = "14";
    document.getElementById("edit-days-fsize").value = "12";
    document.getElementById("edit-time-in-cell-1").checked = false;
    document.getElementById("edit-time-in-cell-0").checked = true;
    document.getElementById("edit-header-heidht").value = "60";
    ...
    document.getElementById("edit-month-type").value = "2";
    document.getElementById("edit-cur-month-color").color.fromString("FFFFFF");
    document.getElementById("edit-cur-month-fsize").value = "12";
    document.getElementById("edit-month-arrow-color").color.fromString("FFFFFF");
    document.getElementById("edit-next-month-color").color.fromString("FFFFFF");
    document.getElementById("edit-next-month-fsize").value = "10";
    document.getElementById("edit-next-month-arrow-color").color.fromString("FFFFFF");
    document.getElementById("edit-prev-month-color").color.fromString("FFFFFF");
    document.getElementById("edit-prev-month-fsize").value = "10";
    document.getElementById("edit-prev-month-arrow-color").color.fromString("FFFFFF");
    document.getElementById("edit-arrow-size").value = "8";
    document.getElementById("edit-weekdays-color").color.fromString("FFFFFF");
    document.getElementById("edit-week-cell-height").value = "25";
...
function spider_calendar_reset_block_theme_4() {
  if (confirm(Drupal.t('Do you really whant to reset theme?'))) {
    ...
    document.getElementById("edit-border-width").value = "6";
    document.getElementById("edit-show-titles-cloud-1").checked = true;
    document.getElementById("edit-show-titles-cloud-0").checked = false;
    document.getElementById("edit-show-date-and-time-in-titlescloud-1").checked = true;
    document.getElementById("edit-show-date-and-time-in-titlescloud-0").checked = false;
    document.getElementById("edit-titles-cloud-text-color").color.fromString("000000");
    document.getElementById("edit-body-bgcolor").color.fromString("E3F9F9");
    document.getElementById("edit-cell-height").value = "25";
    ...
    document.getElementById("edit-cell-bgcolor-selected-events").color.fromString("58A42B");
    ...
    document.getElementById("edit-sundays-fcolor").value = "12";
    document.getElementById("edit-days-fsize").value = "14";
    document.getElementById("edit-time-in-cell-1").checked = false;
    document.getElementById("edit-time-in-cell-0").checked = true;
    document.getElementById("edit-header-heidht").value = "70";
    ...
    document.getElementById("edit-weekdays-fsize").value = "12";
    document.getElementById("edit-event-title-color-popup").color.fromString("000000");;
    document.getElementById("edit-event-title-fsize-popup").value = "12"
    document.getElementById("edit-event-title-family-popup").value = "Arial";
    document.getElementById("edit-event-title-fstyle-popup").value = "Normal";
    document.getElementById("edit-date-color-popup").color.fromString("262626");
    document.getElementById("edit-date-fsize-popup").value = "12";
    document.getElementById("edit-date-family-popup").value = "Arial";
    document.getElementById("edit-date-fstyle-popup").value = "Normal";
    document.getElementById("edit-repeat-rate-1").checked = true;
    document.getElementById("edit-repeat-rate-0").checked = false;
...
function spider_calendar_reset_block_theme_5() {
  if (confirm(Drupal.t('Do you really whant to reset theme?'))) {
    ...
    document.getElementById("edit-cell-bgcolor-selected-events").color.fromString("36A7E9");
    document.getElementById("edit-event-title-color").color.fromString("FFFFFF");
...
function spider_calendar_reset_block_theme_6() {
  if (confirm(Drupal.t('Do you really whant to reset theme?'))) {
    ...
    document.getElementById("edit-border-radius").value = "3";
    document.getElementById("edit-border-width").value = "5";
    document.getElementById("edit-show-titles-cloud-1").checked = true;
    document.getElementById("edit-show-titles-cloud-0").checked = false;
    document.getElementById("edit-show-date-and-time-in-titlescloud-1").checked = true;
    document.getElementById("edit-show-date-and-time-in-titlescloud-0").checked = false;
    ...
    document.getElementById("edit-cell-bgcolor-selected-events").color.fromString("9A0000");
    document.getElementById("edit-event-title-color").color.fromString("000000");
    ...
    document.getElementById("edit-prev-month-fsize").value = "9";
    document.getElementById("edit-prev-month-arrow-color").color.fromString("FFFFFF");
    document.getElementById("edit-arrow-size").value = "9";
    document.getElementById("edit-weekdays-color").color.fromString("000000");
    document.getElementById("edit-week-cell-height").value = "20";
...
function spider_calendar_reset_block_theme_7() {
  if (confirm(Drupal.t('Do you really whant to reset theme?'))) {
    ...
    document.getElementById("edit-year-font-size").value = "16";
    ...
    document.getElementById("edit-cur-month-fsize").value = "11";
...
function spider_calendar_reset_block_theme_8() {
  if (confirm(Drupal.t('Do you really whant to reset theme?'))) {
    ...
    document.getElementById("edit-cell-height").value = "27";
    ...
    document.getElementById("edit-all-days-border").value = "1";
    document.getElementById("edit-sundays-tcolor").color.fromString("000000");
...
function spider_calendar_reset_block_theme_9() {
  if (confirm(Drupal.t('Do you really whant to reset theme?'))) {
    ...
    document.getElementById("edit-border-radius").value = "2";
    document.getElementById("edit-border-width").value = "7";
    document.getElementById("edit-show-titles-cloud-1").checked = true;
    document.getElementById("edit-show-titles-cloud-0").checked = false;
    document.getElementById("edit-show-date-and-time-in-titlescloud-1").checked = true;
    document.getElementById("edit-show-date-and-time-in-titlescloud-0").checked = false;
    ...
    document.getElementById("edit-cell-height").value = "20";
...
function spider_calendar_reset_block_theme_10() {
  if (confirm(Drupal.t('Do you really whant to reset theme?'))) {
    ...
    document.getElementById("edit-cell-bgcolor-selected-events").color.fromString("4AFF9E");
    document.getElementById("edit-event-title-color").color.fromString("000000");
...
function spider_calendar_reset_block_theme_11() {
  if (confirm(Drupal.t('Do you really whant to reset theme?'))) {
    document.getElementById("edit-theme-title").value = "Red Elegant";
    document.getElementById("edit-theme-width").value = "175";
    document.getElementById("edit-week-start-day").value = "su";
    document.getElementById("edit-border-color").color.fromString("D9D9D7");
    document.getElementById("edit-border-radius").value = "3";
    document.getElementById("edit-border-width").value = "6";
    document.getElementById("edit-show-titles-cloud-1").checked = true;
    document.getElementById("edit-show-titles-cloud-0").checked = false;
    ...
    document.getElementById("edit-all-days-border").value = "0";
    document.getElementById("edit-sundays-tcolor").color.fromString("9A0000");
...
function spider_calendar_reset_block_theme_12() {
  if (confirm(Drupal.t('Do you really whant to reset theme?'))) {
    document.getElementById("edit-theme-title").value = "Blue Light";
    document.getElementById("edit-theme-width").value = "175";
    document.getElementById("edit-week-start-day").value = "su";
